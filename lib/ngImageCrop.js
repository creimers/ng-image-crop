	...
	var ImageCropDirectiveCtrl = function () {
	  ...
	  _createClass(ImageCropDirectiveCtrl, [{
	    ...
	    value: function _saveCrop() {
	      ...
	      this.c.result('canvas').then(function (img) {
	        _this.$scope.$apply(function () {
	          var regex = /^data:[a-z]+\/[a-z]+;base64,(.+)/;
	          var base64String = regex.exec(img);
	          _this.croppedImage = _this._b64ToBlob(base64String[base64String.length - 1]);
	        });
	      });
	    }
	  }, {
	      ...
	      if (this._originalImage !== undefined && this.c !== undefined) {
	        (function () {
	          ...
	          reader.onload = function () {
	            _this3.c.bind(reader.result);
	          };
	          reader.readAsDataURL(_this3._originalImage);
	        })();
	      }
	    },
	    get: function get() {
